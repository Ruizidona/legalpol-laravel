...
<div class="container"><br>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <h2 class="card-header text-center alert-primary">{{ __('Registrarse') }}</h2>
                ...
                <div class="card-body">
                   ...
                   <!--     <div class="form-group row">
                        ...
                        <div class="form-group row"><!--telefono-->
                            <label for="telephone_pri" class="col-md-4 col-form-label text-md-right">{{ __('Teléfono') }}</label>

                            <div class="col-md-6">
                                <input id="telephone_pri" type="tel" class="form-control @error('telephone_pri') is-invalid @enderror" name="telephone_pri" value="{{ old('telephone_pri') }}" required autocomplete="telephone">
                        ...
                        <div class="form-group row"><!--telefono2-->
                            <label for="telephone_sec" class="col-md-4 col-form-label text-md-right">{{ __('Teléfono(Opcional)') }}</label>

                            <div class="col-md-6">
                                <input id="telephone_sec" type="tel" class="form-control @error('telephone_sec') is-invalid @enderror" name="telephone_sec" value="{{ old('telephone_sec') }}" autocomplete="telephone_sec">
                     ...
                     <!--   <div class="form-group row">//<!/--pais
                            <label for="telephone" class="col-md-4 col-form-label text-md-right">{{ __('País') }}</label>
                        ...
                        <div class="form-group row"><!--provincia-->
                          ...
                          <div class="form-group row"><!--localidad-->
                            <label for="location" class="col-md-4 col-form-label text-md-right">{{ __('Localidad') }}</label>
                     ...
                     <!--    <div class="form-group row">especialidad
